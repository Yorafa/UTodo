...
from course.views.course import CourseView, OwnCourseListView, OnListCourseListView
...
urlpatterns = [
    ...
    path('<int:pk>/like/', LikeCourseAPIView.as_view()),
    path('<int:pk>/unlike/', UnLikeCourseAPIView.as_view()),
    path('on_list/', OnListCourseListView.as_view()),
